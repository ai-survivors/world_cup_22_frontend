    ...
    <>
      ...
      <section>
        <div className="leading-normal tracking-normal text-white gradient">
          <nav
            id="header"
            className="fixed top-0 z-30 w-full py-1 text-white bg-black opacity-70"
          >
            <div className="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
              <div className="flex items-center pl-4">
                <Link href="/">
                  <img
                    className="hover:scale-110 cursor-grab"
                    src="https://github.com/ai-survivors/world_cup_22_frontend/raw/main/assest/logo.png"
                    width="120"
                  />
                </Link>
              </div>
              <div className="block pr-4 lg:hidden">
                <button
                  id="nav-toggle"
                  className="flex items-center p-1 text-white transition duration-300 ease-in-out transform hover:text-gray-900 focus:outline-none focus:shadow-outline hover:scale-105"
                >
                  <svg
              ...
              <div
                className="z-20 flex-grow hidden w-full p-4 mt-2 text-white bg-white lg:flex lg:items-center lg:w-auto lg:mt-0 lg:bg-transparent lg:p-0"
                id="nav-content"
              >
                <ul className="items-center justify-end flex-1 list-reset lg:flex">
                  <Link href="./Matches">
                    <li className="mr-3">
                      <a
                        className="inline-block px-4 py-2 font-bold no-underline hover:scale-110 hover:text-gray-500 hover:text-underline"
                        href="#"
                      >
                        Matches
                      </a>
                  ...
                  <>
                    <div>
                      <Link href="./Profile">
                        <a
                          className="inline-block px-4 font-bold no-underline hover:scale-110 hover:text-gray-500 hover:text-underline"
                          href="#"
                        >
                          Profile
                        </a>
          ...
          >
            <div class="p-4 md:p-12 text-center lg:text-left">
              ...
              <p class="pt-8 text-sm">
                <h1 class="text-3xl font-bold pt-8 lg:pt-0">Tickets</h1>{" "}
              </p>
        ...
        if (data.owner == user.id){
          ...
          return (
            ...
            <div className="bg-[url('https://images.assetsdelivery.com/compings_v2/gavrby/gavrby2104/gavrby210400021.jpg')]  mt-10  h-80  rounded-3xl bg-cover " >
              ...
              <p class="pt-8 text-sm">
                <h1 class="text-3xl font-bold pt-8 lg:pt-0">Votes</h1>{" "}
              </p>

              <section className="grid grid-cols-1 gap-4 pt-7">
                  {votes.map((vote,idx)=>{
                ...
                {/* <div className="pl-20">Vote 1</div> */}
                {/* <div className="pl-24">Vote 2</div>
                <div className="pt-5 pl-20">Vote 3</div>
                <div className="pt-5 pl-24">Vote 4</div> */}
              </section>
              <div class="mt-6 pr-10 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                <a>
                  <svg
                    class="h-6 fill-current text-blue-600"
                    role="img"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  >
