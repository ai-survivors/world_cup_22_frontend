                            ...
                            <div class="mt-12">
                                <form method='post' onSubmit={handleCreateUser}>
                                    ...
                                    <div>
                                        ...
                                        <input class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="email" placeholder="Enter your email" name='email' required />
                                    </div>
                                    <div class="mt-8">
                                ...
                                <div class="pb-3 mt-5 text-sm font-display font-semibold text-gray-700 text-center">
                                    Already A Member ?
                                    <Link href="/Login">
