    ...
    <>
      <section>
        ...
        <div className="leading-normal tracking-normal text-white gradient">
          <nav
            id="header"
            className="fixed top-0 z-30 w-full text-gray-300 bg-pink-800"
          >
            <div className="container flex flex-wrap items-center justify-between w-full py-2 mx-auto mt-0">
              <div className="flex items-center pl-4">
                <Link href="/">
                  <a
                    className="text-2xl font-bold text-gray-300 no-underline toggleColour hover:text-white lg:text-4xl"
                    href="#"
                  >
                    <svg
              ...
              <div className="block pr-4 lg:hidden">
                <button
                  id="nav-toggle"
                  className="flex items-center p-1 text-black transition duration-300 ease-in-out transform hover:text-gray-900 focus:outline-none focus:shadow-outline hover:scale-105"
                >
                  <svg
              ...
              <div
                className="z-20 flex-grow hidden w-full p-4 mt-2 text-gray-300 bg-white lg:flex lg:items-center lg:w-auto lg:mt-0 lg:bg-transparent lg:p-0"
                id="nav-content"
              >
      ...
      <section>
        <div className="h-screen w-full m-0 p-0 bg-cover bg-[url('https://sportshub.cbsistatic.com/i/r/2021/10/13/007edf34-6472-437f-b6ef-68bc342475b2/thumbnail/1200x675/cc6e3ad0f6e2b33e8b747f5cb742f081/untitled-design-2021-10-13t161851-200.jpg')]">
          <div className="container text-center break-normal md:pt-32">
            ...
            <p className="pt-3 text-xl text-gray-500 md:text-2xl"></p>
          </div>
        </div>
      </section>
    </>
